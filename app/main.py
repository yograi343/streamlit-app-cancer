...
def main():
    ...
    with st.container():
        ...
        st.write(
            "Please connect this app to your cytology lab to help diagnose breast cancer form your tissue sample."
        )
    ...
    col1, col2 = st.columns(
        [4, 1]
    )  # here first column will have 4 times width compared to 2nd one
    with col1:
